...
fn test__new__should_return_an_crc() {
  alg_test := Algorithm.new[u64](u64(0x00000000), u64(0xffffffff), true, true, u64(0xffffffff))
  crc := Crc.new[u64](alg_test)
}

// 8-bit CRC tests
fn test__hash__should_return_a_valid_crc8_autosar() {
  mut crc := crc8_autosar()
